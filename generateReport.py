#########################################################################################
# NOTE: Make sure to set all bVis flags to false in ./src/MidTermProject_Camera.cpp ...	#
...
for detector in detectors:
	for descriptor in descriptors:
		...
		state, output_string = subprocess.getstatusoutput('./2D_feature_tracking %s %s %s' % (detector, descriptor, matchingDescriptorType))
